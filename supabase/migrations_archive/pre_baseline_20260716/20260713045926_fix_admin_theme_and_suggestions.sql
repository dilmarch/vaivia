...
create or replace function public.get_admin_feature_suggestions(
...
revoke all on function public.get_admin_feature_suggestions(integer) from public;
grant execute on function public.get_admin_feature_suggestions(integer) to authenticated;
