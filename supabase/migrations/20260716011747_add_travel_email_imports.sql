...
revoke insert, update on public.travel_email_imports from anon, authenticated;
revoke insert, update on public.travel_email_imports from public;
grant select, delete on public.travel_email_imports to authenticated;
