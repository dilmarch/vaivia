...
Depending on the features you use, VAIVIA may store account details, profile information, trips, destinations, itinerary items, transportation plans, stays, budgets, expenses, passport stamp records, private immunization records, bucket list items, friend connections, feature suggestions, notification settings, theme preferences, and consent choices.
