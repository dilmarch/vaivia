  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        dropdown_root: cn(
          "relative rounded-md border border-input shadow-sm focus-within:border-ring focus-within:ring-[3px] focus-within:ring-ring/50",
        ...
        caption_label: cn(
          ...
          captionLayout === "label"
            ? "text-sm"
            : "flex h-8 items-center gap-1 rounded-md pr-1 pl-2 text-sm [&>svg]:h-3.5 [&>svg]:w-3.5 [&>svg]:text-muted-foreground",
...
function CalendarDayButton({
  ...
  return (
    <Button
      ...
      className={cn(
        "flex h-8 w-8 min-w-8 flex-col gap-1 rounded-lg leading-none font-normal group-data-[focused=true]/day:relative group-data-[focused=true]/day:z-10 group-data-[focused=true]/day:border-ring group-data-[focused=true]/day:ring-2 group-data-[focused=true]/day:ring-ring/50 data-[range-end=true]:rounded-md data-[range-end=true]:bg-primary data-[range-end=true]:text-primary-foreground data-[range-middle=true]:rounded-none data-[range-middle=true]:bg-accent data-[range-middle=true]:text-accent-foreground data-[range-start=true]:rounded-md data-[range-start=true]:bg-primary data-[range-start=true]:text-primary-foreground data-[selected-single=true]:bg-lime-300 data-[selected-single=true]:text-slate-950 hover:bg-white/10 hover:text-white [&>span]:text-xs [&>span]:opacity-70",
        defaultClassNames.day,
        className
      )}
      {...props}
